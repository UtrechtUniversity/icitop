...
renamepath <- paste0("data/102.us-lls/2.data-checks/old and try-out/1_rename_102.us-lls_filled-try.xlsx")

# add a path to the excluded file
excludedpath <- paste0("data/102.us-lls/2.data-checks/old and try-out/102.us-lls_exclude.csv")
