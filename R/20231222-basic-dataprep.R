...
df17<-read_sav("data/24.us-mlsra/2. data checks/Moderators/G2 Children/RACE Recoded_Binary Variable 2019.04.12.sav")
df18<-read_sav("data/24.us-mlsra/2. data checks/Moderators/G2 Children/birthdates_by_id.sav")
df19<-read_sav("data/24.us-mlsra/2. data checks/Moderators/G2 Children/Sex/CSEX.sav")
...
dfs_lower <- lapply(dfs, convert_to_lowercase)

merged_df <- bind_rows(dfs, .id = "source_id")
