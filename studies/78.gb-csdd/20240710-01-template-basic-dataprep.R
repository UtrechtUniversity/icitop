...
studyname <- "78.gb-csdd"

# Path(s) to where the raw data files are that need to be read in and cleaned
file_paths <- c("data/78.gb-csdd/2.data-check/08488-0001-Data.sav")

# Path for writing the raw codebook to
codebookpath <- paste0("data/78.gb-csdd/2.data-check/codebook-raw-78.gb-csdd.xlsx")

# Folder for writing rename files to
renamepath <- "data/78.gb-csdd/2.data-check"
